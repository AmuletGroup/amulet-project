...
/**@brief Structure containing the RR interval received from the peer. */
/** Added by Josiah Hester @ Clemson Univ */
typedef struct
{
    uint16_t rr_interval_value;  /**< RR interval. */
} ble_rr_interval_t;
