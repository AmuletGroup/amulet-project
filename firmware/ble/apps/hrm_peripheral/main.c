...
/**
 * Adapted from Nordic examples for use with GCC toolchain and Amulet White Owl Rev E
 *
 * This makes the Amulet board simulate a heart rate sensor, using the same protocol as
 * the Zephyr and other BLE HRM devices.
 * 
...
#define DEVICE_NAME                      "Amulet_HRM"                               /**< Name of device. Will be included in the advertising data. */
...
static void heart_rate_meas_timeout_handler(void * p_context)
{
    ...
    //      
    //      This is STUPID: - Josiah changed it
