...
static void power_on (void){
	...
	*/
	...
	// //this is a hack to fix the SMCLK to be 1MHZ
	// CSCTL3 &= ~DIVS_3;
	// CSCTL3 |=  DIVS_3;
	// //end hack 

	//SMCLK is running at 8MHz on the bracelet!
	//f_UCxCLK = 8MHz / UCxxBRO = 8MHz / 32 = 250kHz

	UCxxCTLW0 |= UCSSEL_2;                          //Use SMCLK, keep RESET
	UCxxBR0 = 32;                                           //Initial SPI clock must be <400kHz
	UCxxBR1 = 0;                                            
