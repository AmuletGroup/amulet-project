@echo off
:: ===========================================================================
:: Calc2 example, 80x86, Open Watcom compiler
...
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\main2.obj    %SRCDIR%\main2.c
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\calc1.obj    %SRCDIR%\calc1.c
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\calc2.obj    %SRCDIR%\calc2.c
@echo off
