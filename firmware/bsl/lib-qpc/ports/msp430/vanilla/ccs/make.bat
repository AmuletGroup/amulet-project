...
if "%1"=="" (
    ...
    set BINDIR=dbg
    set CCFLAGS=-vmsp --abi=eabi -g --include_path="%CCS_DIR%\tools\compiler\msp430_4.3.3\include" --include_path="%CCS_DIR%\ccs_base\msp430"
)
if "%1"=="rel" (
    echo rel selected
    set BINDIR=rel
    set CCFLAGS=-vmsp --abi=eabi -O0 --include_path="%CCS_DIR%\tools\compiler\msp430_4.3.3\include" --include_path="%CCS_DIR%\ccs_base\msp430" --define=NDEBUG
)
if "%1"=="spy" (
    echo spy selected
    set BINDIR=spy
    set CCFLAGS=-vmsp --abi=eabi -g --include_path="%CCS_DIR%\tools\compiler\msp430_4.3.3\include" --include_path="%CCS_DIR%\ccs_base\msp430" --define=Q_SPY
)
