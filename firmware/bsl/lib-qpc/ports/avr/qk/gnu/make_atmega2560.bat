...
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\qmsm_ini.o %SRCDIR%\qmsm_ini.c
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\qmsm_dis.o %SRCDIR%\qmsm_dis.c
...
%LIB% %LIBFLAGS% %LIBDIR%\libqp_%TARGET_MCU%.a %BINDIR%\qep.o %BINDIR%\qmsm_ini.o %BINDIR%\qmsm_dis.o %BINDIR%\qfsm_ini.o %BINDIR%\qfsm_dis.o %BINDIR%\qhsm_ini.o %BINDIR%\qhsm_dis.o %BINDIR%\qhsm_top.o %BINDIR%\qhsm_in.o
@echo OFF
...
@echo ON
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\qa_ctor.o  %SRCDIR%\qa_ctor.c
...
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\qma_ctor.o %SRCDIR%\qma_ctor.c
...
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\qk_port.o  qk_port.c
