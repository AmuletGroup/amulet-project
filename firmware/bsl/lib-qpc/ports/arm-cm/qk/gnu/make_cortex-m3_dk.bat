@echo off
:: ===========================================================================
:: Product: QP/C buld script for ARM Cortex-M3, QK port, GNU/DevKit ARM
...
if "%1"=="" (
    ...
    set CCOPT=-O
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mthumb -Wall
...
if "%1"=="rel" (
    ...
    set CCOPT=-Os
    set CCFLAGS=-c -mcpu=%ARM_CORE% -mthumb -Wall -DNDEBUG
...
if "%1"=="spy" (
    ...
    set CCOPT=-O
    set CCOPT_QS=-Os
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mthumb -Wall -DQ_SPY
    set ASMFLAGS=-g -mcpu=%ARM_CORE%
)
...
set LIBDIR=%BINDIR%
set LIBFLAGS=rs
erase %LIBDIR%\libqp_%ARM_CORE%_dk.a
...
%LIB% %LIBFLAGS% %LIBDIR%\libqp_%ARM_CORE%_dk.a %BINDIR%\qep.o %BINDIR%\qmsm_ini.o %BINDIR%\qmsm_dis.o %BINDIR%\qmsm_in.o %BINDIR%\qfsm_ini.o %BINDIR%\qfsm_dis.o %BINDIR%\qhsm_ini.o %BINDIR%\qhsm_dis.o %BINDIR%\qhsm_top.o %BINDIR%\qhsm_in.o
@echo off
erase %BINDIR%\*.o
...
%LIB% %LIBFLAGS% %LIBDIR%\libqp_%ARM_CORE%_dk.a %BINDIR%\qs.o %BINDIR%\qs_.o %BINDIR%\qs_blk.o %BINDIR%\qs_byte.o %BINDIR%\qs_dict.o %BINDIR%\qs_f32.o %BINDIR%\qs_f64.o %BINDIR%\qs_mem.o %BINDIR%\qs_str.o
@echo off
erase %BINDIR%\*.o
