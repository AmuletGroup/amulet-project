@echo off
:: ===========================================================================
:: Product: QP/C buld script for ARM Cortex-M4F, QK port, GNU/DevKit ARM
...
if "%1"=="" (
    ...
    set CCOPT=-O
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mfpu=%ARM_FPU% -mfloat-abi=softfp -D__VFP_FP__ -mthumb -Wall
    set ASMFLAGS=-g -mcpu=%ARM_CORE% -defsym=FPU_VFP_V4_SP_D16=1
)
if "%1"=="rel" (
    echo rel selected
    set BINDIR=%QP_PRTDIR%\rel
    set CCOPT=-Os
    set CCFLAGS=-c -mcpu=%ARM_CORE% -mfpu=%ARM_FPU% -mfloat-abi=softfp -D__VFP_FP__ -mthumb -Wall -DNDEBUG
    set ASMFLAGS=-mcpu=%ARM_CORE% -defsym=FPU_VFP_V4_SP_D16=1
)
if "%1"=="spy" (
    echo spy selected
    ...
    set CCOPT=-O
    set CCOPT_QS=-Os
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mfpu=%ARM_FPU% -mfloat-abi=softfp -D__VFP_FP__ -mthumb -Wall -DQ_SPY
    set ASMFLAGS=-g -mcpu=%ARM_CORE% -defsym=FPU_VFP_V4_SP_D16=1
)
...
set LIBDIR=%BINDIR%
set LIBFLAGS=rs
erase %LIBDIR%\libqp_%ARM_CORE%f_dk.a
...
%LIB% %LIBFLAGS% %LIBDIR%\libqp_%ARM_CORE%f_dk.a %BINDIR%\qep.o %BINDIR%\qmsm_ini.o %BINDIR%\qmsm_dis.o %BINDIR%\qmsm_in.o %BINDIR%\qfsm_ini.o %BINDIR%\qfsm_dis.o %BINDIR%\qhsm_ini.o %BINDIR%\qhsm_dis.o %BINDIR%\qhsm_top.o %BINDIR%\qhsm_in.o
@echo off
erase %BINDIR%\*.o
...
@echo on
%CC% %CCFLAGS% %CCOPT% %CCINC% %SRCDIR%\qk.c       -o%BINDIR%\qk.o
%CC% %CCFLAGS% %CCOPT% %CCINC% %SRCDIR%\qk_sched.c -o%BINDIR%\qk_sched.o
%CC% %CCFLAGS% %CCOPT% %CCINC% %SRCDIR%\qk_mutex.c -o%BINDIR%\qk_mutex.o
%ASM% qk_port.s -o %BINDIR%\qk_port.o %ASMFLAGS%

%LIB% %LIBFLAGS% %LIBDIR%\libqp_%ARM_CORE%f_dk.a %BINDIR%\qk.o %BINDIR%\qk_sched.o %BINDIR%\qk_mutex.o %BINDIR%\qk_port.o
@echo off
erase %BINDIR%\*.o
...
%LIB% %LIBFLAGS% %LIBDIR%\libqp_%ARM_CORE%f_dk.a %BINDIR%\qs.o %BINDIR%\qs_.o %BINDIR%\qs_blk.o %BINDIR%\qs_byte.o %BINDIR%\qs_dict.o %BINDIR%\qs_f32.o %BINDIR%\qs_f64.o %BINDIR%\qs_mem.o %BINDIR%\qs_str.o
@echo off
erase %BINDIR%\*.o
