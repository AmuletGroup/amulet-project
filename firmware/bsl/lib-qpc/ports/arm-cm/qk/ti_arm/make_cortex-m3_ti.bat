@echo off
:: ===========================================================================
:: Product: QP/C buld script for ARM Cortex-M3, QK port, TI_ARM comiler
...
if "%1"=="" (
    ...
    set BINDIR=dbg
    set CCFLAGS=-c -g -O -m%ARM_ARCH% --code_state=16 --gcc --abi=eabi -me --gen_func_subsections=on --ual --preproc_with_compile -I%TI_ARM%\include 
    set ASMFLAGS=-c -g -O -m%ARM_ARCH% --code_state=16 --gcc --abi=eabi -me --gen_func_subsections=on --ual --preproc_with_compile -I%TI_ARM%\include 
)
if "%1"=="rel" (
    echo rel selected
    set BINDIR=rel
    set CCFLAGS=-c -O3 -m%ARM_ARCH% --code_state=16 --gcc --abi=eabi -me --gen_func_subsections=on --ual --preproc_with_compile -I%TI_ARM%\include 
    set ASMFLAGS=-c -O3 -m%ARM_ARCH% --code_state=16 --gcc --abi=eabi -me --gen_func_subsections=on --ual --preproc_with_compile -I%TI_ARM%\include 
)
if "%1"=="spy" (
    echo spy selected
    set BINDIR=spy
    set CCFLAGS=-c -g -O -m%ARM_ARCH% --code_state=16 --gcc --abi=eabi -me --gen_func_subsections=on --ual --preproc_with_compile -I%TI_ARM%\include -DQ_SPY 
    set ASMFLAGS=-c -g -O -m%ARM_ARCH% --code_state=16 --gcc --abi=eabi -me --gen_func_subsections=on --ual --preproc_with_compile -I%TI_ARM%\include 
)
...
set LIBDIR=%BINDIR%
set LIBFLAGS=r
erase %LIBDIR%\qp_%ARM_CORE%_ti.lib
...
%LIB% %LIBFLAGS% %LIBDIR%\qp_%ARM_CORE%_ti.lib %BINDIR%\qep.obj %BINDIR%\qmsm_ini.obj %BINDIR%\qmsm_dis.obj %BINDIR%\qmsm_in.obj %BINDIR%\qfsm_ini.obj %BINDIR%\qfsm_dis.obj %BINDIR%\qhsm_ini.obj %BINDIR%\qhsm_dis.obj %BINDIR%\qhsm_top.obj %BINDIR%\qhsm_in.obj
@echo off
erase %BINDIR%\*.obj
...
%CC% %CCFLAGS% %CCINC% %SRCDIR%\q_tick.c
...
%LIB% %LIBFLAGS% %LIBDIR%\qp_%ARM_CORE%_ti.lib %BINDIR%\qa_ctor.obj %BINDIR%\qa_defer.obj %BINDIR%\qa_fifo.obj %BINDIR%\qa_lifo.obj %BINDIR%\qa_get_.obj %BINDIR%\qa_sub.obj %BINDIR%\qa_usub.obj %BINDIR%\qa_usuba.obj %BINDIR%\qeq_fifo.obj %BINDIR%\qeq_get.obj %BINDIR%\qeq_init.obj %BINDIR%\qeq_lifo.obj %BINDIR%\qf_act.obj %BINDIR%\qf_gc.obj %BINDIR%\qf_log2.obj %BINDIR%\qf_new.obj %BINDIR%\qf_pool.obj %BINDIR%\qf_psini.obj %BINDIR%\qf_pspub.obj %BINDIR%\qf_pwr2.obj %BINDIR%\q_tick.obj %BINDIR%\qma_ctor.obj %BINDIR%\qmp_get.obj %BINDIR%\qmp_init.obj %BINDIR%\qmp_put.obj %BINDIR%\qte_ctor.obj %BINDIR%\qte_arm.obj %BINDIR%\qte_darm.obj %BINDIR%\qte_rarm.obj %BINDIR%\qte_ctr.obj
@echo off
erase %BINDIR%\*.obj
...
%LIB% %LIBFLAGS% %LIBDIR%\qp_%ARM_CORE%_ti.lib %BINDIR%\qk.obj %BINDIR%\qk_sched.obj %BINDIR%\qk_mutex.obj %BINDIR%\qk_port.obj
@echo off
erase %BINDIR%\*.obj
...
%LIB% %LIBFLAGS% %LIBDIR%\qp_%ARM_CORE%_ti.lib %BINDIR%\qs.obj %BINDIR%\qs_.obj %BINDIR%\qs_blk.obj %BINDIR%\qs_byte.obj %BINDIR%\qs_dict.obj %BINDIR%\qs_f32.obj %BINDIR%\qs_f64.obj %BINDIR%\qs_mem.obj %BINDIR%\qs_str.obj
@echo off
erase %BINDIR%\*.obj
